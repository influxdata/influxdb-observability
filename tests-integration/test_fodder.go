...
func init() {
	{
		...
		dp2.SetCount(144320)
		dp2.SetSum(53423)
		dp2.SetExplicitBounds(pcommon.NewImmutableFloat64Slice([]float64{0.05, 0.1, 0.2, 0.5, 1}))
		dp2.SetBucketCounts(pcommon.NewImmutableUInt64Slice([]uint64{24054, 33444, 100392, 129389, 133988, 144320}))
		m = ilMetrics.Metrics().AppendEmpty()
