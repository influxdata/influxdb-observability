...
const (
	...
	AttributeResourceAttribute              = "otel.resource.attributes"
	AttributeSpanAttribute                  = "otel.span.attributes"
	AttributeEventAttribute                 = "otel.event.attributes"
	AttributeLinkAttribute                  = "otel.link.attributes"
